...
<body class="page-template page-template-page-blank page-template-page-blank-php page page-id-341 woocommerce-no-js dgwt-wcas-bc-1-1-7 lightbox nav-dropdown-has-arrow">
   ...
   max-width: 100%;
        ...
        <main id="main" class="">
            ...
            <div id="content" role="main" class="content-area">
                ...
                <div class="row row-full-width align-middle align-center contact_us" id="row-1697190908">
                    <div class="col dir_add medium-5 large-5">
                        <div class="col-inner text-left">
                            <div class="row" id="row-1672438157">
                                <div class="col small-12 large-12">
                                    <div class="col-inner text-center">
                                        <h2>Address</h2>
                                        <div class="add_add">2414 Babcock Rd, Ste 106,
                                            <br />San Antonio, TX 78229-4870 (Bexar County) </div>
                                        <div><a href="https://goo.gl/maps/2ixiPGVzMnS2" target="_blank"><i class="fa fa-map-marker" aria-hidden="true"></i><span>DIRECTIONS</span></a></div>
                                    </div>
                                </div>
                                <div class="col small-12 large-12">
                                    <div class="col-inner text-center">
                                        <h2>Store &amp; Pharmacy Hours</h2>
                                        <div class="add_add">Monday-Friday : 9am to 5pm
                                            
                                            <br />Saturday-Sunday : Closed
                                            <br />Holidays : Call store for details</div>
                                    </div>
                                </div>
                                <div class="col small-12 large-12">
                                    <div class="col-inner text-center">
                                        <h2>Contact Us</h2>
                                        <div class="add_add">Phone :(210)-417-4567 / (888)-412-5929
                                            <br />Fax : (210)-858-6007 / (888)-413-1021
                                            <br />Email : <a href="mailto:503B@aspcares.com"> 503B@aspcares.com</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col medium-6 small-12 large-6">
                        <div class="col-inner text-center">
                            <p>
                                <a href="https://goo.gl/maps/kifySc76NPt" target="_blank"><img src="../assets/images/antonio.jpg" /></a>
                            </p>
                        </div>
                    </div>
                ...
                <!-- <div class="container mt-4 mb-3 margin">
                  <div class="row">

                    <div class="text-center justify-content-center p-4 mt-3 mb-3">


                      <a href="https://us.fullscript.com/welcome/aspcares" target="_blank" class="see-all-links supplements-button btn btn-default btn-block btn-outline h3">Shop Supplements</a>
                ...
                <div class="container-fluid padding-top">
                 ...
                 <a href="https://us.fullscript.com/welcome/aspcares" target="_blank" class="image-links">
                  <img src="../assets/images/supplyment.jpg" class="img-fluid custom-image-image"/>
                                        ...
                                        <h1 class="main_section_title shop" lang="en">SHOP SUPPLEMENTS
                                        </h1>
                ...
                <div class="row" id="row-990713597">
                    <div class="col small-12 large-12">
                        <div class="col-inner">
                            <h2 style="text-align: center;margin-bottom:30px;">Enquire Now</h2>
                            <div role="form" class="wpcf7" id="wpcf7-f908-p341-o1" lang="en-US" dir="ltr">
                                <div class="screen-reader-response"></div>
                                <form action="/contact-us/#wpcf7-f908-p341-o1" method="post" class="wpcf7-form" novalidate="novalidate">
                                    <div style="display: none;">
                                        <input type="hidden" name="_wpcf7" value="908" />
                                        <input type="hidden" name="_wpcf7_version" value="5.1.1" />
                                        <input type="hidden" name="_wpcf7_locale" value="en_US" />
                                        <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f908-p341-o1" />
                                    ...
                                    <p class="form-row form-row-first">
                                        ...
                                        <br />
                                        <span class="wpcf7-form-control-wrap facility-name"><input type="text" name="facility-name" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Facility Name" /></span>
                                    </p>
                                    <p class="form-row form-row-first">
                                    ...
                                    <p class="form-row form-row-last">
                                        ...
                                        <br />
                                        <span class="wpcf7-form-control-wrap address-line-2"><input type="text" name="address-line-2" value="" size="40" class="wpcf7-form-control wpcf7-text" aria-invalid="false" placeholder="Address Line 2" /></span>
                                    </p>
                                    <p class="form-row form-row-first">
                                    ...
                                    <p class="form-row form-row-last">
                                        ...
                                        <br />
                                        <span class="wpcf7-form-control-wrap number-744"><input type="number" name="number-744" value="" class="wpcf7-form-control wpcf7-number wpcf7-validates-as-required wpcf7-validates-as-number" aria-required="true" aria-invalid="false" placeholder="Zip" /></span>
                                    </p>
                                    <p class="form-row form-row-first">
                                        <label> Phone<span class="required">*</span></label>
                                        <br />
                                        <span class="wpcf7-form-control-wrap number-13"><input type="number" name="number-13" value="" class="wpcf7-form-control wpcf7-number wpcf7-validates-as-required wpcf7-validates-as-number" aria-required="true" aria-invalid="false" placeholder="Phone" /></span>
                                    </p>
                                    <p class="form-row form-row-last">
                                        <label> Email address <span class="required">*</span></label>
                                        <br />
                                        <span class="wpcf7-form-control-wrap email-528"><input type="email" name="email-528" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Email" /></span>
                                    </p>
                                    <p style="clear:both;" class="woocommerce-FormRow form-row">
                                        <label> Message <span class="required">*</span></label>
                                        <br />
                                        <span class="wpcf7-form-control-wrap textarea-887"><textarea name="textarea-887" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Message"></textarea></span>
                                    </p>
                                    <p style="clear:both;" class="woocommerce-FormRow form-row">
                                        <input type="submit" value="Send to Pharmacist" class="wpcf7-form-control wpcf7-submit" />
                                    </p>
                ...
                <div class="row align-middle" id="row-1743408234">
                    <div class="col img_mob medium-4 small-12 large-4">
                        <div class="col-inner text-left">
                            <div class="img has-hover x md-x lg-x y md-y lg-y" id="image_405868406">
                                <div class="img-inner dark">
                                    <img width="300" height="445" src="https://temp.503bfacility.com/wp-content/uploads/2018/12/jaqueline.png" class="attachment-large size-large" alt="" srcset="https://temp.503bfacility.com/wp-content/uploads/2018/12/jaqueline.png 300w, https://temp.503bfacility.com/wp-content/uploads/2018/12/jaqueline-270x400.png 270w, https://temp.503bfacility.com/wp-content/uploads/2018/12/jaqueline-64x95.png 64w" sizes="(max-width: 300px) 100vw, 300px" />
                                </div>
                    ...
                    <div class="col medium-8 small-12 large-8">
                        <div class="col-inner">
                            <h2 class="hh2">JAQUELINE ESQUEDA<br />
</h2>
                            <p class="add_add" style="font-size:15px;">Jaqueline Esqueda is the Pharmacist-in-Charge at the ASP Cares 503B Compounding Facility in San Antonio where she leads a team that’s uncompromisingly dedicated to delivering quality product. ASP Cares is the only outsourcing facility in San Antonio and one of only eight in Texas.</p>
                            <p class="add_add" style="font-size:15px;">While she works in a closed-door facility with limited exposure to patients, when she does get the opportunity, Jaqueline enjoys teaching patients about their disease state and how proper administration of medications will help their disease management. As far as she is concerned, the more Jaqueline’s patients know and understand, the better equipped they are to manage their disease.</p>
                            <p class="add_add" style="font-size:15px;">Jaqueline graduated Magna Cum Laude with her Bachelor of Science degree from the University of the Incarnate World. She received her Doctor of Pharmacy degree from the Feik School of Pharmacy where she graduated Summa Cum Laude. While in school, she received the following awards: Department of Pharmaceutical Sciences Outstanding Graduate Award; Mylan Institute of Pharmacy – Excellence in Pharmacy Award; and HEB Pharmacy Scholarship recipient.</p>
                            <p class="add_add" style="font-size:15px;">She is a member of the Bexar County Pharmacy Association and holds the following licenses/certifications: Texas State Board of Pharmacy License; Pharmacist – National Sterile Compounding Certification; Spanish Language Practitioner Certification; APhA Pharmacy-Based Immunizer; and Smoking Cessation Counselor Certification.</p>
                            <p class="add_add" style="font-size:15px;">Jaqueline is married and has three young daughters, along with a dog named Rambo. In her spare time, she enjoys attending life music events and crafting. </p>
                        </div>
                    </div>
