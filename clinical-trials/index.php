...
<head>
    ...
    <title>Clinical Trials | ASP Cares</title>
    ...
    <style type="text/css">
		...
		textarea{
            border: 1px solid #20b726 !important;
    ...
    <style type="text/css">
        ...
        .dgwt-wcas-search-wrapp .dgwt-wcas-sf-wrapp .dgwt-wcas-search-submit::before {
            border-color: transparent #ee2a32
        }
    ...
    <script type="text/javascript">
        WebFontConfig = {
            google: {
                families: ["Lato:regular,700", "Lato:regular,400", "Lato:regular,700", "Dancing+Script", ]
            }
        };
        (function() {
                ...
                <div id="content" role="main" class="content-area">
                    ...
                    <div class="row align-middle about_txt" id="row-59831429">
                        ...
                        <div class="col medium-12 small-12 large-12">
                            <div class="col-inner">
                                <h1>Investigational Research</h1><br>
                                <p class="about-text" style="text-align: justify;">ASP Cares is an FDA registered outsourcing facility specializing in the preparation of investigational research drugs at different stages of the clinical research process.</p>
 <p class="about-text" style="text-align: justify;">                               
Our experienced and cGMP trained pharmacists can help you through the drug development process, offering services in the following areas:

<ul>
<li class="lime">Drug study blinding</li>
<li class="lime">Simple aseptic transfers</li>
<li class="lime">Consultation</li>
<li class="lime">Research and development</li>
<li class="lime">Manufacturing</li>
<li class="lime">Stability studies
</li>
</ul>
</p><br>
  <p class="about-text" style="text-align: justify;">We have worked with many different types of institutions to provide the product they need to conduct their research.  These include:</p>
  <p class="about-text" style="text-align: justify;">
    <ul>
<li class="lime">The US Department of Veterans Affairs</li>
<li class="lime">The US Department of Defense</li>
<li class="lime">Hospital systems</li>
<li class="lime">Universities</li>
<li class="lime">Physician clinics</li>
<li class="lime">Private corporations</li>
    

    </ul>
 </p><br>
 <p class="about-text" style="text-align: justify;">
  We can provide drugs that are both sterile and non-sterile in any dosage form.  We ensure that these drugs meet all the requirements for human administration and application for investigational use.  All drug products undergo extensive testing before release to ensure you receive a drug product that meets the highest standards of quality.</p><br>

<p class="about-text" style="text-align: justify;">
    Quality release testing may include:
    <ul>
<li class="lime">Appearance</li>
<li class="lime">Content uniformity</li>
<li class="lime">pH</li>
<li class="lime">Potency</li>
<li class="lime">Sterility</li>
<li class="lime">Bacterial endotoxin</li>
<li class="lime">Antimicrobial effectiveness</li>
<li class="lime">Subvisible particulate matter</li>
</ul> 

</p><br>
<p class="about-text" style="text-align: justify;">
For more information, please contact us at <a href="mailto:503b@aspcares.com">503b@aspcares.com</a> or <a href="tel:(210) 417-4567">(210) 417-4567</a> to speak with one of our trained pharmacists. You may also fill out the form below to discuss about your project.</p>
                            ...
                            <div class="col-2 large-12 col pb-0">
                                ...
                                <div class="account-register-inner">
                                    ...
                                    <form method="post" class="register" enctype="" action="scripts.php" id="503b">

                                        <p class="form-row form-row-first">
                                            <label for="billing_first_name">Name: <span class="required">*</span></label>
                                            <input type="text" class="input-text" name="f_name" id="f_name" placeholder="Name" value="" required />
                                        </p>
                                        

                                        <p class="form-row form-row-last now">
                                            <label for="billing_card_name">Email: <span class="required">*</span></label>
                                            <input type="text" class="input-text" name="f_email" id="f_email" placeholder="Email" value="" required />
                                        </p>

                                         <p class="form-row form-row-first now">
                                            <label for="billing_card_name">Phone: <span class="required">*</span></label>
                                            <input type="number" class="input-text" name="f_phone" id="f_phone" placeholder="Phone" value="" required />
                                        </p>

                                         <p class="form-row form-row-first now">
                                            <label for="billing_card_name">Message: <span class="required">*</span></label>
                                            <textarea class="input-text" name="f_msg" id="f_msg" placeholder="Message" value="" required></textarea>
                                        </p>
                                ...
                                <!-- <p style="position: absolute;top: -22px;">* Fields are Mandatory</p> -->
                                <p style="clear:both;" class="woocommerce-FormRow form-row">
                                    ...
                                    <button type="submit" style="margin-top: 32px; text-transform: uppercase;" class="woocommerce-Button button" name="" value="Submit" >Submit to pharmacist</button>
                                </p>

                                <div class="row full cf" id="successmessage" style="color: #ecde60;">
                
                <h3 style="color: #000">Thank you for your enquiry</h3>
<p style="color: #000">Your message has been sent successfully.</p>
              </div>
        ...
        jQuery(document).ready(function($) {
            ...
            $('#503b').submit(function(event) {
                ...
                posting.done(function(data) {
                    ...
                    var form = document.getElementById("503b");
                    form.reset();
    ...
    margin-bottom: 4px; margin-left: 10px;color: #337ab7;" class="btn" data-popup-open3="popup-4" href="#">(View Terms)</a>
        ...
        <script type='text/javascript'>
            ...
            var wc_cart_fragments_params = {
                "ajax_url": "",
                "wc_ajax_url": "\/?wc-ajax=%%endpoint%%",
                "cart_hash_key": "wc_cart_hash_df2b43ebf4897b222a24124d9f882f16",
                "fragment_name": "wc_fragments_df2b43ebf4897b222a24124d9f882f16"
            };
            /* ]]> */
        </script>
