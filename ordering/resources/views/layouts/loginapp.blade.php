...
<head>
    ...
    <link href="{{ asset('adminassets/css/colors/red.css') }}" id="theme" rel="stylesheet">
    ...
    <nav class="navbar navbar-default navbar-static-top">
        <div class="container">
            <div class="navbar-header">
                <!-- Branding Image -->
                <a class="navbar-brand" href="{{ url('/') }}" style="color: #6a3919;">
                    <img src="{{ asset('logo.png') }}" alt="{{ config('app.name') }}" class="dark-logo" style="width: 63%;" />
                </a>
            </div>
