    ...
    jQuery(function($) {
        $('#frm1').submit(function(e){
            ...
            if(flag == "2"){
                ...
                $.ajax({
                        type    : 'POST',
                        url     : "<?php echo e(URL::to('/do-order/general-products')); ?>",
                        data    : formData,
                        cache   : false,
...
<?php echo $__env->make('layouts.companyapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/503bfacility.com/httpdocs/ordering/resources/views/company/dashboard.blade.php ENDPATH**/ ?>