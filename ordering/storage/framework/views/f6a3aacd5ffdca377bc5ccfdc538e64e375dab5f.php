            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="post" id="frm1">
						...
						<table class="tablesaw table-striped table-hover table-bordered table">
							<thead>
								<tr>
									...
									<th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="0" style="width: 15%;">Qty./Pellet size</th>
                        ...
                        <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						<div class="col medium-3 small-12 large-3 text-right mr-3" style="position: fixed; top: 50%; right: 0; z-index: 50;">
...
<?php echo $__env->make('layouts.companyapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/coffeeoverchat.com/503-admin.coffeeoverchat.com/resources/views/company/my_catalog.blade.php ENDPATH**/ ?>