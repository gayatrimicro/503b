			...
			<nav class="navbar top-navbar navbar-expand-md navbar-light">
				<div class="navbar-header">
					<a class="navbar-brand" href="<?php echo e(url('/')); ?>">
						<b>
							<img style="width: 80%;" src="<?php echo e(asset('logo.png')); ?>" class="dark-logo" />
						</b>
					</a>
				</div>
...
<?php /**PATH /var/www/vhosts/503bfacility.com/httpdocs/ordering/resources/views/layouts/adminapp.blade.php ENDPATH**/ ?>