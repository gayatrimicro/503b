			...
			<nav class="navbar top-navbar navbar-expand-md navbar-light">
				<div class="navbar-header">
					<a class="navbar-brand" href="<?php echo e(url('/')); ?>">
						<b>
							<img style="width: 80%;" src="<?php echo e(asset('logo.png')); ?>" alt="" class="dark-logo" />
						</b>
					</a>
				</div>
			...
			<div class="scroll-sidebar">
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						...
						<li> <a class="waves-effect waves-dark" href="<?php echo e(url('/company-dashboard')); ?>"><i class="mdi mdi-gauge"></i>Dashboard</a></li>
						<li> <a class="waves-effect waves-dark" href="<?php echo e(url('/my-catalog')); ?>"><i class="mdi mdi-book-open"></i>My Catalog</a></li>
						<li> <a class="waves-effect waves-dark" href="<?php echo e(url('/location')); ?>"><i class="mdi mdi-map-marker-radius"></i>Location</a></li>
						<!-- <li> <a class="waves-effect waves-dark" href="<?php echo e(url('/company/product')); ?>"><i class="mdi mdi-pill"></i>My Products</a></li> -->
					</ul>
				</nav>
...
<?php /**PATH /var/www/vhosts/503bfacility.com/httpdocs/ordering/resources/views/layouts/companyapp.blade.php ENDPATH**/ ?>