                            ...
                            <div role="form" class="wpcf7" lang="en-US" dir="ltr">
                                ...
                                <form id="san-form" method="post" class="wpcf7-form" novalidate="novalidate">
                                    ...
                                    <p class="form-row form-row-first">
                                        ...
                                        <br />
                                        <span class="wpcf7-form-control-wrap last-name"><input type="text" name="san-last-name" id="san-last-name" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Last Name" required/></span>
                                    </p>
...
$(document).ready(function() { 
    $('#san-form').submit(function(event) {
