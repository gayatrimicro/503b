...
// $get_data = mysqli_query($conn, "SELECT * FROM category");
?>
<!DOCTYPE html>
...
<table style="font-family: 'Gotham', 'NotoSans', sans-serif !important; margin-bottom: 55px;" width="672">
  <tbody>
    ...
    <td class="tthead" width="66"><strong>Qty / Size</strong></td>
    </tr>
    <?php $products_data = mysqli_query($conn_new, "SELECT * FROM products WHERE category_id = '".$cat['id']."' AND deleted_at IS NULL ORDER BY sequence ASC");
      ...
      <tr>
        <td width="198">
          <?php if($products['strength']==null && $products['pellet_size']==null){ ?>
            <b><?php echo $products['product_name'] ?></b>
          <?php }else{ echo $products['product_name']; } ?>
        </td>
        <td width="144"><?php echo $products['strength'] ?></td>
        <td width="66"><?php echo $products['pellet_size'] ?></td>
      </tr>
    <?php } ?>
  </tbody>
</table>
