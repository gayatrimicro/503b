...
$get_data = mysqli_query($conn_new, "SELECT * FROM categories ORDER BY sequence ASC");
?>
<!DOCTYPE html>
...
<table style="font-family: 'Gotham', 'NotoSans', sans-serif !important; margin-bottom: 55px;" width="672">
  <tbody>
    ...
    <?php $products_data = mysqli_query($conn_new, "SELECT * FROM products WHERE category_id = '".$cat['id']."'");
