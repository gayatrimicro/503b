                ...
                <div id="content" role="main" class="content-area">
                    ...
                    <div class="banner has-hover about_bg" id="banner-45478987">
                        ...
                        <style scope="scope">
                            ...
                            #banner-45478987 .bg.bg-loaded {
                                background-image: url(../assets/images/drug.jpg);
                            }
                    ...
                    <div class="row align-middle about_txt" id="row-59831429">
                        ...
                        <div class="col medium-12 small-12 large-12">
                            <div class="col-inner">
                                <h1>Drug Shortage / Backordered</h1><br>
                                <p class="about-text" style="text-align: justify;">Drug shortages can occur for a variety of reasons, some of which may include manufacturing issues and delays, concerns with the manufacturer quality system, natural disasters, increased demand for a drug, active or inactive ingredient shortages, or due to manufacturer discontinuations. Drug shortage can adversely impact patient care and result in in delays of medical procedures.</p>
                                <p class="about-text" style="text-align: justify;">ASP Cares is an FDA registered, 503B outsourcing facility that specializes in compounding back-ordered, discontinued medications. Physicians and hospital systems should obtain drugs on the shortage list from a 503B outsourcing facility since quality is integrated into every product. All injectable medications are tested for potency, sterility, bacterial endotoxins limits, and subvisible particulate matter prior to release.</p>
                                <p class="about-text" style="text-align: justify;">
                                    The FDA maintains a database of the Current and Resolved Drug Shortages and Discontinuations on their website. <a href="https://www.accessdata.fda.gov/scripts/drugshortages/default.cfm" target="_blank" rel="nofollow">Click here</a> to see the drugs currently in shortage.
                                </p>

                                <p class="about-text" style="text-align: justify;">
                                    If you are experiencing issues due to drug shortages, please enter your requirements below so we can meet your needs. We will reply within 2 hours.</p>
                            </div>
                            <!--  form start -->
                            <div class="col-2 large-12 col pb-0">
                                ...
                                <div class="account-register-inner">
                                   ...
                                   <form method="post" class="register" enctype="" action="scripts.php" id="503b">
                                        ...
                                        <p class="form-row form-row-first qtym">
                                            <label for="billing_first_name">Drug<span class="required">*</span></label>
                                            <input type="text" class="input-text" name="drug_name" id="drug_name" placeholder="Drug" value="" required />
                                        </p>
                                        <p class="form-row form-row-last qtym">
                                            <label for="billing_last_name">Strength <span class="required">*</span></label>
                                            <input type="text" class="input-text" name="strength_n" id="strength_n" placeholder="Strength" value="" required />
                                        </p>
                                        <p class="form-row form-row-first qtym">
                                            <label for="billing_company">Qty <span class="required">*</span></label>
                                            <input type="text" class="input-text" name="qty_no" id="qty_no" placeholder="Qty" value="" required/>
                                        </p>

                                        <p class="form-row form-row-first now qtym">
                                            <label for="billing_card_name">Contact Name <span class="required">*</span></label>
                                            <input type="text" class="input-text" name="co_name" id="co_name" placeholder="Contact Name " value="" required />
                                        </p>

                                        <p class="form-row form-row-last now qtym">
                                            <label for="">Phone Number<span class="required">*</span></label>
                                            <input type="number" class="input-text" name="po_number" id="po_number" placeholder="Phone Number" value="" required />
                                        </p>

                                         <p class="form-row form-row-last now qtym">
                                            <label for="">Email<span class="required">*</span></label>
                                            <input type="email" class="input-text" name="email_id" id="email_id" placeholder="Email" value="" required />
                                        </p>
                                ...
                                <p style="clear:both;" class="woocommerce-FormRow form-row">
                                    ...
                                    <button type="submit" style="margin-top: 32px;" class="woocommerce-Button button" name="" value="Submit" >Submit</button>
                                </p>
